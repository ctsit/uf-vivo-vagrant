...
# Basics.
apt-get install -y git vim screen wget curl raptor2-utils unzip software-properties-common
...
# Install Tomcat 8 with JAVA_HOME export so Tomcat starts when install completes,
installTomcat () {
